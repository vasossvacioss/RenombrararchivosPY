...
# Agregar un Label en la esquina derecha de la ventana
label_pagina = tk.Label(root, text="https://vasossvacioss.github.io/portafolio3/", anchor="se")
label_pagina.pack(side="bottom", padx=10, pady=10)
